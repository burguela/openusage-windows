...
The app isn't code-signed yet, so Windows SmartScreen may warn the first time; choose **More info → Run anyway**. See [docs/windows.md](https://github.com/burguela/openusage-windows/blob/main/docs/windows.md) for how Quota Tray works.
